...
// exit('Sorry,This site doesn\'t allowed proxy access');
// 自动开启SESSION
...
// 构造执行路由
$__controller = isset ( $_REQUEST [$GLOBALS ['G_SP'] ['url_controller']] ) ? $_REQUEST [$GLOBALS ['G_SP'] ['url_controller']] : $GLOBALS ['G_SP'] ['default_controller'];
$__action = isset ( $_REQUEST [$GLOBALS ['G_SP'] ['url_action']] ) ? $_REQUEST [$GLOBALS ['G_SP'] ['url_action']] : $GLOBALS ['G_SP'] ['default_action'];
